...
#define EMAC_EMACCFG_PRELEN_SHIFT   (0)
#define EMAC_EMACCFG_PRELEN         (0x3 << EMAC_EMACCFG_PRELEN_SHIFT)
...
#define EMAC_EMACMIIADDR_PLA        (0x1F << EMAC_EMACMIIADDR_PLA_SHIFT)
#define EMAC_EMACMIIADDR_MII_SHIFT  (6)
#define EMAC_EMACMIIADDR_MII        (0x1F << EMAC_EMACMIIADDR_MII_SHIFT)
...
#define EMAC_EMACMIIDATA_DATA       (0xFFFF)

#define EMAC_EMACFLOWCTL_PT_SHIFT   (16)
#define EMAC_EMACFLOWCTL_PT         (0xFFFF << EMAC_EMACFLOWCTL_PT_SHIFT)
...
#define EMAC_EMACVLANTG_VL          (0xFFFF)
...
#define EMAC_EMACRWUFF_WAKEUPFIL    (0xFFFFFFFF)

#define EMAC_EMACPMTCTLSTAT_WUPFRRST        (1 << )
#define EMAC_EMACPMTCTLSTAT_RWKPTR_SHIFT    (24)
#define EMAC_EMACPMTCTLSTAT_RWKPTR    (0x7 << EMAC_EMACPMTCTLSTAT_RWKPTR_SHIFT)
...
#define EMAC_EMACLPITIMERCTRL_LST     (0x3FF << EMAC_EMACLPITIMERCTRL_LST_SHIFT)
#define EMAC_EMACLPITIMERCTRL_TWT     (0xFFFF)
...
#define EMAC_EMACADDRH_AE               (1 << 31)
#define EMAC_EMACADDRH_SA               (1 << 30)
#define EMAC_EMACADDRH_MBC_SHIFT        (24)
#define EMAC_EMACADDRH_MBC              (0x3F << EMAC_EMACADDRH_MBC_SHIFT)
#define EMAC_EMACADDRH_ADDRHI           (0xFFFF)
#define EMAC_EMACADDRL_ADDRLO           (0xFFFFFFFF)
...
enum eth_clk {
	ETH_CLK_020_035MHZ = ETH_MACMIIAR_CR_HCLK_DIV_16,
